...
function renderHome(root) {
  ...
  root.innerHTML = `
    ...
    <section class="home-grid">
      <a class="home-card" href="#/overview"><p class="eyebrow">Read</p><h2>Start with the overview</h2><p>Course structure, Jupyter, and how the original ebook is organized.</p></a>
...
function renderRoute() {
  ...
  showStage("page");
  if (item.type === "quiz") renderQuiz(page, item.quiz);
